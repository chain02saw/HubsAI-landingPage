// src/components/onboarding/dashboard/ComingSoon.tsx
...
export const ComingSoon: React.FC<ComingSoonProps> = ({ tabName }) => {
  ...
  return (
    <div className="text-center py-16">
      <motion.div
        className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-primary-500/20 to-primary-600/20 rounded-full flex items-center justify-center border border-primary-500/30"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
      ...
      >
        <div className="p-6 bg-primary-500/10 border border-primary-500/20 rounded-xl max-w-lg mx-auto">
          ...
          <div className="flex space-x-2">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-400 text-sm"
            />
