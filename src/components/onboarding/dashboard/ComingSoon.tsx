...
export const ComingSoon: React.FC<ComingSoonProps> = ({ tabName }) => {
  const getFeatureDetails = (name: string) => {
    switch (name.toLowerCase()) {
      ...
      case 'rewards': // Updated from 'referrals'
        return {
          icon: '💰', // Updated icon from '👥'
          description: 'Track and claim your HUBS rewards from staking, brand partnerships, and platform activities.',
          features: [
